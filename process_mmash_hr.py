...
if __name__ == "__main__":
    ...
    quantiles = [0.35] #[0.30, 0.325, 0.35, 0.375, 0.4, 0.425, 0.45, 0.475, 0.5, 0.525, 0.55, 0.575, 0.6, 0.625, 0.65, 0.675,
                # 0.7, 0.725, 0.75, 0.775, 0.8, 0.825, 0.85, 0.875, 0.9, 0.925, 0.95, 0.975, 1.0]
    time_merge_blocks = [240] # [30, 60, 120, 240, 360, 420]
    window_lengths = [32.50] # [25, 27.5, 30, 32.5, 35, 37.5, 40, 42.5, 45, 47.5, 50]
    start_hour = 15
    ...
    with tempfile.TemporaryDirectory() as output_path:
        ...
        bigdf.to_csv("results_MMASH_best.csv.gz", index=False)
